<template>
    <div class="lift-card">
        <div class="user-info">
            <RouterLink class="user-link" :to="{ name: 'viewProfile', params: {userId: post.user_id}}">
                <img class="picture">
                <div class="username">
                    <h2>{{ post.username }}</h2>
                </div>
        ...
        <div class="lift-info">
            <Router-link class="link-card" :to="{name: 'viewPost', params: {postid: this.post.id }}">
                <div class="lift-element">
                    <div class="icon"><MuscleTypeIcon /></div>
                ...
                <div class="lift-element">
                    <div class="icon"><ClockIcon /></div>
                    <h3>{{ post.duration }}</h3>
                </div>
                <div class="lift-element">
                    <div class="icon"><SetIcon /></div>
                    <h3>Sets: {{ post.totalSets }}</h3>
                </div>
                <div class="lift-element">
                    <div class="icon"><MassMovedIcon /></div>  
                    <h3>Mass: {{ post.totalMass }} lbs</h3>
                </div>
            </Router-link>
        </div>
